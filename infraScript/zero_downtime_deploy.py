...
class ServiceManager:
    ...
    def _find_current_service(self) -> None:
        ...
        if not current_service:
            self.current_name, self.current_port = 'team4_2', self.services['team4_2']
        else:
    ...
    def _run_container(self, name: str, port: int) -> None:
        os.system(
            f"docker run -d --name={name} --restart unless-stopped -p {port}:8015 -e TZ=Asia/Seoul -v /dockerProjects/team4/volumes/gen:/gen --pull always ghcr.io/pnu-2024-07-team4/team4")
